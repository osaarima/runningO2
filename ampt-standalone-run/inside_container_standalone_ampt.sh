...
alienv setenv O2/latest-dev-o2,AliRoot/latest-master-o2 -c o2-sim -j 1 --seed ${seed} -n ${Nevt} -m FV0 FT0 ITS PIPE MFT -g external --configKeyValues 'GeneratorExternal.fileName=/home/osaarima/cernbox/ToyFlowHeidi/simO2/gengen.C;GeneratorExternal.funcName=gengen("../testdir/ampt-output00.root", "ampt")'
