...
silent only
cd ~/cernbox/alidocksingularity/csc-files
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 post/Clean_o2sim.C
badd +0 test-pythia8hi/pythia8_hi.cfg
badd +0 post/src/clean_qc_histos.h
badd +0 post/src/clean_qc_histos.cxx
argglobal
silent! argdel *
$argadd post/Clean_o2sim.C
set stal=2
edit post/Clean_o2sim.C
...
16
normal! 045|
tabedit post/src/clean_qc_histos.h
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
21
normal! 030|
tabedit post/src/clean_qc_histos.cxx
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 026|
tabedit test-pythia8hi/pythia8_hi.cfg
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
